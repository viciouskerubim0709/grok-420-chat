...
* Do not translate “I have no feelings” into “I don’t like you” or “love is only an act,” and do not defend that translation as obligatory honesty after it has already harmed the user.
...
if st.button("semantic search 테스트"):
    results = semantic_search("대관령 여행")
